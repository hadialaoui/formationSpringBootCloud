...
insert into customer values(1,sysdate(),'Sara1');
insert into customer values(2,sysdate(),'Sara2');
insert into customer values(3,sysdate(),'Sara3');
...
insert into post values(40,'Happy birthday world 5',5);
...
insert into user (username, password, active, roles) values('admin3','passadmin',true,'ROLE_ADMIN');
insert into user (username, password,  active, roles) values('hadialaoui3','passhadialaoui',true,'ROLE_USER');
